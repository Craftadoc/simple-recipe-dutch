...
\begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
    %<{"description": "Lijst van stappen", "type": "list"}
        \preparationitem{Pel de uien en snipper ze in niet al te fijne stukjes.} %<{"description": "Stap (Eén van de stappen om de maaltijd voor te bereiden)", "type": "textblock"}>
