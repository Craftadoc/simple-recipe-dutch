...
{A4330D} %<{"type": "color", "description": "Kies je eigen kleur (Optioneel)", "initialColor": "A4330D"}>
...
\begin{center}
\includegraphics[width=\linewidth]{frietstoofvlees.jpg}%<{"description": "Foto van de maaltijd", "type": "crop", "aspect": 2}>
\end{center}
\recipesection{Friet stoofvlees} %<{"description": "Titel van je recept", "type": "text"}>
\vspace{0pt}
\\
\textcolor{darkcol}{\normalsize\faClockO\recipetext
{3u} %<{"description": "Hoelang duurt het om te maken?", "type": "text"}>
}
\textcolor{darkcol}{\normalsize\faUser\recipetext
{4 personen} %<{"description": "Hoeveel porties?", "type": "text"}>
}
\textcolor{darkcol}{\normalsize\faNewspaperO\recipetext
{Dagelijksekost} %<{"description": "Wie heeft het recept bedacht of van waar ken je het?", "type": "text"}>
}
\vspace{5pt}
\begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
    %<{"description": "Lijst van stappen", "type": "list"}
        \preparationitem{Pel de uien en snipper ze in niet al te fijne stukjes.} %<{"description": "Stap (Eén van de stappen om de maaltijd voor te bereiden)", "type": "textblock", "injectBrackets": true}>
...
%<{"description": "Lijst van ingrediënten", "type": "list"}
